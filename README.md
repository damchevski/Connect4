...
На самата форма е поставена табла (7 колони и 6 редици), на која играчите со клик на соодветна колона наизменично поставуваат по едно од нивните топчиња.
...
# Финален изглед
Изглед на почетната форма на која се внесуваат имиња за играчите и се започнува играта со клик на копчето:
![sl1](/form1.png)

Изглед на новата форма откако ќе се започне играта, лабелите со жолто/црвено покажуваат на тоа кој играч моментално е на потег:
![sl2](/form2.png)

На следнава слика е прикажана таблата по неколку поставени топчиња:
![sl3](/igrac2Turn.png)

Формата откако ќе победи еден од играчите:
![sl4](/igrac2Win.png)

Победничката низа на топчиња пулсира откако еден играч ќе победи:
![sl5](/igrac2WinPulse.png)
